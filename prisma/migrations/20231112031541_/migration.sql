...
-- AddForeignKey
ALTER TABLE "order_products" ADD CONSTRAINT "order_products_paymentId_fkey" FOREIGN KEY ("paymentId") REFERENCES "payment_methods"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
